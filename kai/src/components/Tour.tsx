...
const STEPS: Step[] = [
  ...
  { selector: '[data-viewnav]',
    title: 'Five focused views',
    body: 'The dashboard is split into Command, Money, Growth, Operations and Comms. Tap a tab or press 1–5 to switch. Each view shows only its own panels — no more endless scroll.',
    side: 'bottom' },
  { selector: '#tour-cmdk',
    title: '⌘K — Command bar',
